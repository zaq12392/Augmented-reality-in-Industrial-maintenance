...
public class Find : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Texture2D dstTexture = Resources.Load("matchshapestest1") as Texture2D;
        ...
        for (int i = 0; i < srcContours.Count; i++)
        {
            ...
            Imgproc.putText(dstMat, " " + returnVal, point, Core.Formatter_FMT_NUMPY, 0.4, new Scalar(0, 255, 0), 1, Imgproc.LINE_AA, false);
        }
